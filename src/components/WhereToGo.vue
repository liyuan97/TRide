<template>
  <BottomDrawer>
<div
    class="destinations pb-6 no-scrollbar overflow-y-scroll pt-8 flex flex-col justify-start items-center"
>
<button class="destination rounded-3xl border-4 border-gray-300 p-3 mb-3 flex flex-row justify-start items-center space-x-4 mx-4"
        @click="newTrip()">
...
<button class="destination rounded-3xl border-2 border-gray-300 p-3 mb-3 flex flex-row justify-start items-center space-x-4 mx-4"
...
const destinations = reactive([
  ...
  },
  {
    ...
    coordinates: [120.47553, 31.228245]
  },
  {
    title: 'Work',
